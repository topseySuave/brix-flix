...
import 'package:brix_flix/screen/movie_details/youtube_video_preview.dart';
import 'package:brix_flix/widgets/cinemas_showing.dart';
...
class GreyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double radius = min(width * 2, height / 1.8);
                                ...
                                children: <Widget>[
                                  SizedBox(
                                      width:
                                          MediaQuery.of(context).size.width / 2,
                                      child:
                                          movieStats('Duration', '02:33:12')),
                                  SizedBox(child: movieStats('Review', '+40')),
                                ],
                              ),
                            ],
                          ),
